...
class TravelHistoryCell: UITableViewCell, UITextFieldDelegate {
    ...
    @IBOutlet weak var txtDeparturePlace:UITextField!
    @IBOutlet weak var txtDestinationPlace:UITextField!
    @IBOutlet weak var txtSelectMode:UITextField!
    @IBOutlet weak var txtSelectClass:UITextField!
    @IBOutlet weak var txtTravellerName:UITextField!
