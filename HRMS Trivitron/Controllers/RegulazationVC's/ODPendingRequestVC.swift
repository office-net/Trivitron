...
class ODPendingRequestVC: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.title = "Regularization Pending Request"
    ...
    
    {
        ...
        AF.request( base.url+"OD_PendingRequest", method: .post, parameters: parameters, encoding: JSONEncoding.default)
...
extension ODPendingRequestVC:UITableViewDataSource,UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "ODPendingCell") as! ODPendingCell
...
class ODPendingCell: UITableViewCell {
