...
class COPendingVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "COPendingCell") as! COPendingCell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let vc = storyboard?.instantiateViewController(withIdentifier: "CODetailsVC")as! CODetailsVC
        vc.isFromCancelVC = false
        vc.isFromPendingVC = true
        let index =  indexPath.row
    ...
    func RequestApi()
    {
        ...
        AF.request( base.url+"CompOff_PendingRequest", method: .post, parameters: parameters, encoding: JSONEncoding.default)
...
class COPendingCell: UITableViewCell {
